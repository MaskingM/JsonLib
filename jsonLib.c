...
/*
* 销毁 Long Number 类型类型节点
* @param	pNode Long Number类型节点
* @return void
*/
...
/*
* 数字节点序列化，做数组元素，不需要键名称
* @param	pNode	pJsonLongNumberNode 数字节点
* @param	isContainsKey	BOOLEAN	是否包含键
* @return	char*	序列化字符串
*/
...
/*
 * 向 json 对象中添加 Long Number类型 键值对象
 * @param	pObject		json 对象
 * @param	key			属性名称
 * @param	value		属性值
 * @return	void
...
/*
* 向 json 数组节点中数组尾部追加长数字
* @param	pArrayNode pJsonArrayNode 数组节点
* @param	number UINT64	需要添加的数字
* @return	void
*/
